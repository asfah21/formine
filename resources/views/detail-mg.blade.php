    ...
    <script>
        function saveAsPDF() {
			...
			var opt = {
				...
				filename:     'Form-P2H-Grader-GSI.pdf', // Nama file PDF yang akan disimpan
...
@endphp
            ...
            <td colspan=6 class=xl135 style='border-bottom:none !important;'>24-Juli-23</td>
            <td class=xl126c width=16 style='border-right:.5pt solid black;width:5pt'></td> <!-- copy this syntax-->
            </tr>
            <tr height=14 style='mso-height-source:userset;height:11.1pt'>
            <td colspan=23 height=14 class=xl137 style='border-right:.5pt solid black;border-bottom: none !important;
            height:11.1pt;border-left:none'>MOTOR GRADER</td>
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TANDEM</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tandem == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>LEVEL OLI HIDROLIK</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->level_oli_hidro == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->level_oli_hidro == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>4</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>GIGI PERSENELING</td>
                        <!-- Pemisah Kolom untuk Baik -->
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SELANG / PIPA HIDROLIK</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->selang_pipa_hidro == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->selang_pipa_hidro == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left: none'>TEKANAN ANGIN</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tekanan_angin == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tekanan_angin == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KLAKSON MUNDUR</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->klakson_mdr2 == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->klakson_mdr2 == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TANGKI HIDRO</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tangki_hidro == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tangki_hidro == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tangki_hidro == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>EMS / CMS</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->ems_cms2 == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->ems_cms2 == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>BLADE / MOLOBOARD</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->blade == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SISTEM HIDROLIK</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->sistem_hidro == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->sistem_hidro == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>CUTTING EDGES</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->cutting_edge == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->cutting_edge == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->cutting_edge == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>CIRCLE BLADE</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->circle_blade == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->circle_blade == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->circle_blade == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>GOOSENECK</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->goose_neck == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->goose_neck == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->goose_neck == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SILINDER HIDROLIK</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->silinder_hidro == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->silinder_hidro == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>11</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>PEDAL MODULAR</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->pedal_modul == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->pedal_modul == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->pedal_modul == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SILINDER ARTIKULASI</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->silinder_arti == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->silinder_arti == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->silinder_arti == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>12</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TUAS GIGI</td>
                        <!-- Pemisah Kolom untuk Baik -->
            ...
            <td class=xl94></td>
            <td class=xl95>13</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>THROTTLE</td>
                        <!-- Pemisah Kolom untuk Baik -->
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>INDIKATOR SARINGAN UDARA</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->indiaktor_saringan_udara == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->indiaktor_saringan_udara == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->indiaktor_saringan_udara == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>WIPER</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->wiper == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TABUNG ANGIN</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tabung_angin == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tabung_angin == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tabung_angin == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>LEVEL AIR RADIATOR</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->level_air_radi == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->level_air_radi == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>21</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>EMERGENCY STEERING</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->emergency_steering == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->emergency_steering == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->emergency_steering == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'></td>
                        ...
                        @endif
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tricon4 == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tricon4 == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td class=xl74></td>
            <td class=xl108 width=16 style='width:12pt'></td>
            <td class=xl98 style="border: none !important;"></td>
            <td colspan=10 class=xl161 style='border:none !important;'></td>

                            <td class=xl161 style="border:none !important;"></td>

                            <td class=xl101 style="border: none !important;"></td>
            <td class=xl108 width=16 style='width:12pt'></td>
            <td class=xl66></td>
            <td class=xl66></td>
            <td class=xl66></td>
