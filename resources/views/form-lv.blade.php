        ...
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16 !pt-28">
            ...
            <div class="container mx-auto p-0">
                ...
                <form action="{{ route('form-lv') }}" method="POST" id="myForm">
                    ...
                    <div class="grid gap-4 sm:gap-5 sm:grid-cols-2">
                        ...
                        <div x-data="dropdown()" class="relative">
                            <label for="no_unit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor
                                Unit</label>
                            <div class="relative flex items-center">
                                <button @click="toggle"
                            ...
                            <div class="form-group">
                                ...
                                <div class="p-2 border rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                    <div class="flex items-center gap-4 justify-center"> <!-- Added justify-center -->
                                        ...
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" name="exmp" id="exmp3" value="Tidak Ada"
                                                class="hidden peer" />
                                            <div
                                                class="w-6 h-6 border-2 border-gray-600 bg-gray-600 rounded-md flex items-center justify-center">
                                                <!-- Dash Icon -->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="w-3 h-3 fill-gray-900 dark:fill-white" viewBox="0 0 20 20"
                                                    fill="currentColor">
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div class="flex-2">
                                                ...
                                                <span class="text-sm font-medium text-gray-900 dark:text-white">
                                                    <b>{{ sprintf('%02d', $counter) }}.
                                                        {{ $fieldLabels[$field] ?? ucfirst(str_replace('_', ' ', $field)) }}</b></span>
                                            </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="flex items-start mt-3 mb-2">
                                ...
                                <label for="terms"
                                    class="ms-2 text-justify text-sm font-medium text-gray-900 dark:text-gray-300">Data P2H
                                    yang saya kirim adalah akurat dan sesuai keadaan unit yang sebenarnya. Saya siap
                                    bertanggung jawab dan menerima sanksi apabila terbukti memberikan informasi yang tidak
                                    sesuai<a href="#"
                                        class="text-blue-600 hover:underline dark:text-blue-500">.</a></label>
                            </div>
                ...
                <div id="chatBubble"
                    ...
                    <a href="{{ url('./hasil-lv') }}" id="chatButton" class="chat-bubble-btn">
                        <!-- Chat Bubble Icon -->
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        chatButton.addEventListener('click', function() {
                            window.location.href = './hasil-lv'; // Navigate to the URL
                        });
                    });
                </script>
                ...
                <script>
                    ...
                    document.getElementById('submitButton').addEventListener('click', function(event) {
                        ...
                        if (!selectedUnit) {
                            ...
                            document.getElementById('no_unit').scrollIntoView({
                                behavior: 'smooth',
                                block: 'center'
                            });
                ...
                {{-- <script>
                    document.getElementById('submitButton').addEventListener('click', function() {
                        // Scroll ke atas ketika clik submit button
