...
@section('title', 'Form Motor Grader')
...
@section('content')
    ...
    <section class="min-h-screen bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16 !pt-28">
            <img class="azvan h-auto max-w-full rounded-lg" src="{{ asset('storage/images/MG.svg') }}" alt="Azvan IT">
            ...
            <div class="container mx-auto p-0">
                ...
                <form action="{{ route('form-mg') }}" method="POST" id="myForm">
                    @csrf
                ...
                <div id="chatBubble"
                    ...
                    <a href="{{ url('./hasil-mg') }}" id="chatButton" class="chat-bubble-btn">
                        <!-- Chat Bubble Icon -->
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        chatButton.addEventListener('click', function() {
                            window.location.href = './hasil-mg'; // Navigate to the URL
                        });
                    });
                </script>
                ...
                <script>
                    function dropdown() {
                        return {
                            ...
                            units: Array.from({ length: 5 }, (_, i) => `MG.${String(i + 1).padStart(3, '0')}`)
                            .filter(unit => !['MG.004', 'MG.003'].includes(unit)),
