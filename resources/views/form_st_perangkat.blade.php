    ...
    <section class="min-h-screen bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16 !pt-28">
            ...
            <div class="container mx-auto p-0">
                <form action="{{ route('form_st_perangkat') }}" method="POST" id="myForm">
                    ...
                    <div class="grid gap-4 sm:gap-5 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2 hidden">
                            <label for="nama_form"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Form</label>
                            <div class="relative flex items-center">
                                <input value="Serah Terima Perangkat" type="text" name="nama_form" id="nama_form"
                                ...
                                <select id="assetSelect" name="id_assets"
                                    ...
                                    @foreach ($assets_ku as $asset)
                                        <option value="{{ $asset->asset_id }}"
                                            ...
                                            data-spesifikasi="{{ $asset->spesifikasi }}" data-ram="{{ $asset->ram }}"
                                            data-tgl_serah_terima="{{ $asset->tgl_serah_terima }}"
                                            data-brand="{{ $asset->brand }}" data-kondisi="{{ $asset->kondisi }}"
                                            data-device_type="{{ $asset->device_type }}"
                            ...
                            <div class="bg-white dark:bg-gray-800 shadow">
                                <table class="w-full text-sm text-gray-900 dark:text-white">
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700 ">
                                        <tr class="*:px-4 *:py-3">
                                            <td class="w-1/3 font-medium align-top p-2">S/N</td>
                                            <td class="w-2/3 text-right md:text-left p-2">
                                                <span id="serial_number" class="break-words">-</span>
                                            </td>
                                        </tr>
                                        <tr class="bg-gray-50 dark:bg-gray-700 *:px-4 *:py-3">
                                            <td class="font-medium align-top p-2">Spesifikasi</td>
                                            <td class="text-right md:text-left p-2">
                                                <span id="spesifikasi" class="break-words">-</span>
                                            </td>
                                        </tr>
                                        <tr class="*:px-4 *:py-3">
                                            <td class="font-medium align-top p-2">RAM</td>
                                            <td class="text-right md:text-left p-2">
                                                <span id="ram" class="break-words">-</span>
                                            </td>
                                        </tr>
                                        <tr class="bg-gray-50 dark:bg-gray-700 *:px-4 *:py-3">
                                            <td class="font-medium align-top p-2">Tgl Terima</td>
                                            <td class="text-right md:text-left p-2">
                                                <span id="tgl_serah_terima" class="break-words">-</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="sm:col-span-1">
                            <div class="bg-white dark:bg-gray-800 shadow">
                                <table class="w-full text-sm text-gray-900 dark:text-white">
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700 ">
                                        <tr class="*:px-4 *:py-3">
                                            <td class="w-1/3 font-medium align-top p-2">Merek</td>
                                            <td class="w-2/3 text-right md:text-left p-2">
                                                <span id="brand" class="break-words">-</span>
                                            </td>
                                        </tr>
                                        <tr class="bg-gray-50 dark:bg-gray-700 *:px-4 *:py-3">
                                            <td class="font-medium align-top p-2">Kondisi</td>
                                            <td class="text-right md:text-left p-2">
                                                <span id="kondisi" class="break-words">-</span>
                                            </td>
                                        </tr>
                                        <tr class="*:px-4 *:py-3">
                                            <td class="font-medium align-top p-2">Device</td>
                                            <td class="text-right md:text-left p-2">
                                                <span id="device_type" class="break-words">-</span>
                                            </td>
                                        </tr>
                                        <tr class="bg-gray-50 dark:bg-gray-700 *:px-4 *:py-3">
                                            <td class="font-medium align-top p-2">Lokasi</td>
                                            <td class="text-right md:text-left p-2">
                                                <span id="lokasi" class="break-words">-</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        @php
                            $counter = 1;
                            $combined = array_map(null, $fields_ku, $ket_ku);
                        @endphp

                        @foreach ($combined as [$fielda, $kets])
                            <div class="flex flex-col gap-4 mb-1">
                                <div class="form-group">
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div class="flex-2">
                                                <span class="text-sm font-medium text-gray-900 dark:text-white">
                                                    <b>{{ sprintf('%02d', $counter) }}. {{ $my_label[$fielda] ?? ucfirst(str_replace('_', ' ', $fielda)) }}</b>
                                                </span>
                                            </div>
                                            ...
                                            <div class="flex-1 flex items-center justify-end gap-1.5 h-full">
                                                ...
                                                <label class="flex items-center cursor-pointer">
                                                    <input type="radio" name="{{ $fielda }}" value="Ya" class="hidden peer" checked />
                                                    <div class="w-6 h-6 border-2 border-gray-300 peer-checked:border-green-600 peer-checked:bg-green-600 rounded-md flex items-center justify-center">
                                                ...
                                                <!-- Checkbox Style for Rusak -->
                                                <label class="flex items-center cursor-pointer">
                                                    <input type="radio" name="{{ $fielda }}" value="Tidak" class="hidden peer" />
                                                    <div class="w-6 h-6 border-2 border-gray-300 peer-checked:border-red-600 peer-checked:bg-red-600 rounded-md flex items-center justify-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 fill-gray-900 dark:fill-white" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <!-- Input tambahan untuk keterangan -->
                                    <div class="sm:col-span-2 mt-1">
                                        <label for="{{ $kets }}" class="block text-sm font-medium text-gray-900 dark:text-white"></label>
                                        <div class="relative flex items-center">
                                            <input type="text" name="{{ $kets }}" id="{{ $kets }}"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="relative flex items-center">
                                <input type="text" name="software_terinstall" id="software_terinstall"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Tuliskan software yang terinstall..." maxlength="70" required />
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="4"
                                ...
                                maxlength="100" placeholder="Keterangan tambahan..."></textarea>
                        </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        // Inisialisasi Tom Select untuk fitur pencarian
                        const assetSelect = document.getElementById('assetSelect');
                        if (assetSelect) {
                            new TomSelect(assetSelect, {
                                maxItems: 1,
                                placeholder: 'Pilih atau cari Asset...',
                                searchField: ['text'],
                                sortField: {
                                    field: 'text',
                                    direction: 'asc'
                        ...
                        // Menerapkan gaya Flowbite ke elemen ts-control jika ada
                        const tsWrapper = document.querySelector('.ts-control');
                        if (tsWrapper) {
                            tsWrapper.classList.add(
                                'bg-gray-50', 'border', 'border-gray-300', 'text-gray-900',
                                'focus:ring-primary-500', 'focus:border-primary-500',
                                'dark:bg-gray-700', 'dark:border-gray-600', 'dark:text-gray-900',
                                'dark:focus:ring-primary-500', 'dark:focus:border-primary-500',
                                'block', 'w-full', 'py-3'
                            );

                            tsWrapper.style.borderRadius = '7px'; // Border-radius 8px atau .5rem
                            tsWrapper.style.padding = '11px'; // Menambah padding
                        }
                    });
                </script>
                ...
                <script>
                    document.getElementById('assetSelect').addEventListener('change', function() {
                        ...
                        const fields = [
                            'serial_number', 'spesifikasi', 'ram',
                            'tgl_serah_terima', 'brand', 'kondisi', 'device_type', 'lokasi'
                        ];

                        fields.forEach(field => {
                            document.getElementById(field).textContent =
                                selectedOption.dataset[field] || '-';
                        });
                    });
                </script>
