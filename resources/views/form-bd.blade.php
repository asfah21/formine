...
@section('content')
    ...
    <section class="min-h-screen bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16 !pt-28">
            <img class="azvan h-auto max-w-full rounded-lg" src="{{ asset('storage/images/BD.svg') }}" alt="image description">
            ...
            <div class="container mx-auto p-0">
                ...
                <form action="{{ route('form-bd') }}" method="POST" id="myForm">
                    @csrf
                    ...
                    <div class="grid gap-4 sm:gap-5 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="flex items-start mt-3 mb-2">
                                ...
                                <label for="terms" class="ms-2 text-justify text-sm font-medium text-gray-900 dark:text-gray-300">Saya menyatakan bahwa data P2H yang saya kirim adalah akurat dan sesuai kondisi unit yang sebenarnya. Saya bersedia bertanggung jawab dan menerima sanksi jika terbukti bahwa data yang saya kirimkan tidak sesuai<a href="#" class="text-blue-600 hover:underline dark:text-blue-500">.</a></label>
                            </div>
                ...
                <div id="chatBubble"
                    ...
                    <a href="{{ url('./hasil-bd') }}" id="chatButton" class="chat-bubble-btn">
                        <!-- Chat Bubble Icon -->
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        chatButton.addEventListener('click', function() {
                            window.location.href = './hasil-bd'; // Navigate to the URL
                        });
                    });
                </script>
