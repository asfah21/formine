...
@endphp
            ...
            height:11.1pt;border-left:none'>DUMP TRUCK</td>
            ...
            <td colspan=8 rowspan="4" class=xl184>  <!-- tempat tanda tangan user -->
                <img id="res-img" src="{{ asset('storage/images/ttd_dt/' . $Dtl->dt_id . '.png') }}" alt="No data" style="width: 43%; height: 90%; margin: 7% 0% 0% 0%;"></td>
            <td class=xl87></td>
            <td class=xl87></td>
            <td class=xl87></td>
            <td class=xl87></td>
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>BAN MUKA / BELAKANG</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->ban_muka_blk == "Baik")
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>RETARDER</td>
                    ...
                    @if ($Dtl->retarder2 == "Baik")
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->retarder2 == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->retarder2 == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>LAMPU MUKA BELAKANG</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->lampu_muka_blk == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->lampu_muka_blk == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>LEVEL OLI TRANSMISI</td>
                    ...
                    @if ($Dtl->level_oli_trans == "Baik")
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->level_oli_trans == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->level_oli_trans == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>REM KAKI</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->rem_kaki == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->rem_kaki == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>REM PARKIR</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->rem_parkir == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->rem_parkir == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td class=xl94></td>
            <td class=xl95>4</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left: none'>LEVEL BAHAN BAKAR</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->level_bahan_bakar == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->level_bahan_bakar == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->level_bahan_bakar == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>GIGI PERSNELING</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->gigi_pers == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->gigi_pers == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TANGKI UDARA</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tangki_udara == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tangki_udara == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tangki_udara == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>5</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left: none'>SARINGAN UDARA</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->saringan_udara2 == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->saringan_udara2 == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->saringan_udara2 == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KLAKSON MUNDUR</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->klakson_mundur == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->klakson_mundur == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TABUNG ACCUMULATOR</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tabung_accu == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tabung_accu == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tabung_accu == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>6</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TEKANAN ANGIN</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tekanan_udara == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tekanan_udara == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tekanan_udara == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SILINDER PENGIKAT (HOIST)</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->hoist == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td class=xl94></td>
            <td class=xl95>7</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SEAT / TEMPAT DUDUK</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->seat_tempat_ddk == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->seat_tempat_ddk == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->seat_tempat_ddk == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SILINDER HIDROLIK</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->silinder_hidrolik == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->silinder_hidrolik == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->silinder_hidrolik == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>PUMP TAKE OFF / PTO</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->pto == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>BATTERY / AKI</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->battery_aki == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->battery_aki == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>PENGATUR STIR</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->pengatur_stir == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->pengatur_stir == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td class=xl94></td>
            <td class=xl95>11</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>PEDAL REM</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->pedal_rem == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->pedal_rem == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->pedal_rem == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TALI KIPAS (FAN BELTS)</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tali_kipas == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tali_kipas == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tali_kipas == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>PEDAL GAS</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->pedal_gas == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->pedal_gas == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SARINGAN UDARA</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->saringan_udara == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->saringan_udara == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td class=xl94></td>
            <td class=xl95>14</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TUAS GIGI TRANSMISI</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tuas_gigi == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tuas_gigi == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tuas_gigi == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KIPAS KACA (WIPERS)</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->wiper == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td class=xl94></td>
            <td class=xl95>15</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>GAS TANGAN (THROTLLE)</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->gas_tangan == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->gas_tangan == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->gas_tangan == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>EMS / CMS (Apabila ada)</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->ems_cms == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>HANDEL KONTROL</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->handle_kontrol == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->handle_kontrol == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->handle_kontrol == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>LAMPU MUKA / BELAKANG</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->lampu_muka_blk2 == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->lampu_muka_blk2 == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KNALPOT (EXHAUST)</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->knalpot == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->knalpot == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->knalpot == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KLAKSON MUNDUR</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->klakson_mdr == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->klakson_mdr == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>EMS / CMS</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->ems_cms_2 == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->ems_cms_2 == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>LAMPU PUTAR (STROBE)</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->lampu_ptr == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->lampu_ptr == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>21</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>AIR CONDITIONER</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->ac == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>PIN DUMP</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->pin_dump == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->pin_dump == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->pin_dump == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'></td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kap_mesin == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->kap_mesin == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KEBOCORAN UDARA</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->kebocoran_udara == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kebocoran_udara == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->kebocoran_udara == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td class=xl108 width=16 style='width:12pt'></td>
            <td class=xl95>4</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>BATU DI SELA RODA</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->batu_disela_roda == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->batu_disela_roda == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->batu_disela_roda == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl161 style='border-right:.5pt solid black;border-left:none;border-top:none !important;'>KEBERSIHAN EQUIPMENT</td>
                        ...
                        @endif
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kebersihan_equip == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl101 >&#10006;</td>
                        @elseif ($Dtl->kebersihan_equip == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl101 >-</td>
                        @else
                            <td class=xl101 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SUARA TRANSMISI</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->suara_transmisi == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->suara_transmisi == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->suara_transmisi == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
