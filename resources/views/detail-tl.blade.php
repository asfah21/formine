    ...
    <script>
        function saveAsPDF() {
			...
			var opt = {
				...
				filename:     'Form-P2H-TowerLamp-GSI.pdf', // Nama file PDF yang akan disimpan
...
@endphp
    ...
    <tr>
        ...
        height:12.0pt'>TOWER LAMP (TL)</td>
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa kondisi jack TL</td>
                        ...
                        @if ($Dtl->jack_tl == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->jack_tl == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa kondisi baut-baut penahan cover</td>
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->baut_cover == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->baut_cover == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->baut_cover == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa kelengkapan TL</td>
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->kelengkapan_tl == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kelengkapan_tl == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->kelengkapan_tl == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->sebelum_mesin_hidup == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->sebelum_mesin_hidup == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->sebelum_mesin_hidup == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa jumlah solar</td>
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->jumlah_solar == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->jumlah_solar == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->jumlah_solar == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa level oli mesin</td>
        <!-- Pemisah Kolom untuk Baik -->
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa kebocoran oli mesin</td>
         <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->kebocoran_oli_mesin == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kebocoran_oli_mesin == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->kebocoran_oli_mesin == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa level air baterai</td>
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->level_air_battery == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->level_air_battery == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->level_air_battery == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa level air radiator</td>
        <!-- Pemisah Kolom untuk Baik -->
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa kebocoran solar</td>
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->kebocoran_solar == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kebocoran_solar == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->kebocoran_solar == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa kabel/wiring tidak ada yang kendor atau lepas</td>
         <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->kabel_wiring_kendor == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kabel_wiring_kendor == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->kabel_wiring_kendor == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa instalasi/kabel power tidak ada yang rusak</td>
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->instalasi_kabel_power == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->instalasi_kabel_power == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->instalasi_kabel_power == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->setelah_mesin_hidup == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->setelah_mesin_hidup == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->setelah_mesin_hidup == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <!-- Pemisah Kolom untuk Baik -->
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->meteran_normal == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->meteran_normal == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Pindahkan selektor ke posisi ON</td>
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->selector_on == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->selector_on == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->selector_on == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa apakah ada suara atau getaran tidak normal</td>
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->suara_getaran_normal == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->suara_getaran_normal == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->suara_getaran_normal == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td colspan=21 class=xl128 style='border-right:.5pt solid black;border-left:none'>Periksa kondisi winch</td>
        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->kondisi_switch == "Baik")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10004;</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kondisi_switch == "Rusak")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>&#10006;</td>
                        @elseif ($Dtl->kondisi_switch == "Tidak Ada")
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'>-</td>
                        @else
                            <td colspan=3 class=xl131 style='border-right:.5pt solid black;border-left:none'></td>
                        @endif
        ...
        <td class=xl161>1.</td>
        <td class=xl81 colspan=14 style='mso-ignore:colspan'>Nyalakan lampu satu
        persatu tiap 3 menit</td>
        <td class=xl81></td>
        <td class=xl81></td>
        <td class=xl81></td>
        <td class=xl81></td>
        ...
        <td class=xl81></td>
        <td class=xl81>2.</td>
        <td class=xl81 colspan=16 style='mso-ignore:colspan'>Segera Matikan TL jika
        ...
        <td colspan=11 rowspan=5 class=xl151 style='border-right:.5pt solid black;border-top:none!important;border-left:none!important;'>
            <img id="res-img" src="{{ asset('storage/images/ttd_tl/' . $Dtl->tl_id . '.png') }}" alt="No data" style="width: 55%; height: 90%; margin: 7% 0% 0% 0%;">
        </td>
