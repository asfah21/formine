...
@section('content')
    ...
    <section class="min-h-screen bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-5xl lg:py-16 !pb-40 !pt-28">
            ...
            <a href="{{ route('todo.create') }}" class="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex items-center me-2 mb-2">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="w-full md:w-1/2">
                        <form method="GET" action="{{ route('todo.index') }}" class="flex items-center">
                        ...
                        <tbody>
                            @forelse ($workOrders as $mh)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-center whitespace-nowrap">{{ $mh->ticket_number }}</td>
                                    <td
                                    ...
                                    <td class="px-4 py-3 text-justify">{{ $mh->description }}</td>
