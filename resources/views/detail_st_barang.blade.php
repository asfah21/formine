    ...
    <script>
        function saveAsPDF() {
			...
			var opt = {
				...
				filename:     'Form-P2H-Manhaul-GSI.pdf', // Nama file PDF yang akan disimpan
...
@endphp
            ...
            <td colspan=8 rowspan="4" class=xl184>  <!-- tempat tanda tangan user -->
                <img id="res-img" src="{{ asset('storage/images/ttd_mh/' . $manHauls->mh_id . '.png') }}" alt="No data" style="width: 43%; height: 90%; margin: 7% 0% 0% 0%;"></td>
            <td class=xl87></td>
            <td class=xl87></td>
            <td class=xl87></td>
            <td class=xl87></td>
            ...
            <td colspan="12" rowspan="4" class=xl71> <!-- Tanda Tangan Pengawas-->
                    <img id="res-img-pw" src="{{ asset('storage/images/ttd_mh_pw/' . $manHauls->status) }}" alt="Belum diapprove" style="width: 50%; height: 90%; margin: 0% 0% 0% 0%;"></td>
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SUARA MESIN</td>
                        ...
                        @endif
            <td class=xl108 width=16 style='width:12pt'></td>
            <td colspan=12 class=xl200>{{ $manHauls->pengawas}}</td> {{-- Nama Pengawas --}}
            <td class=xl73></td>
            </tr>
            <tr height=16 style='mso-height-source:userset;height:12.0pt'>
            <td height=16 class=xl74 style='height:12.0pt'></td>
            ...
            <td colspan=39 style="text-align:left"class=xl201>&nbsp; &nbsp; &nbsp;{{ $manHauls->pesan}}</td>
            <td class=xl74></td>
            </tr>
            <tr height=12 style='mso-height-source:userset;height:9.0pt'>
            <td height=12 class=xl119 style='height:9.0pt'></td>
