...
@section('content')
    ...
    <section class="min-h-screen bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16 !pt-28">
            <img class="azvan h-auto max-w-full rounded-lg" src="{{ asset('storage/images/EXCA.svg') }}" alt="image description">
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        chatButton.addEventListener('click', function() {
                            window.location.href = './hasil-exca'; // Navigate to the URL
                        });
                    });
                </script>
