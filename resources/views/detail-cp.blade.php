    ...
    <script>
        function saveAsPDF() {
			...
			var opt = {
				...
				filename:     'Form-P2H-Compactor-GSI.pdf', // Nama file PDF yang akan disimpan
...
@endphp
            ...
            height:11.1pt;border-left:none'>COMPACTOR</td>
            ...
            <td colspan=8 rowspan="4" class=xl184>  <!-- tempat tanda tangan user -->
                <img id="res-img" src="{{ asset('storage/images/ttd_cp/' . $Dtl->cp_id . '.png') }}" alt="No data" style="width: 43%; height: 90%; margin: 7% 0% 0% 0%;"></td>
            <td class=xl87></td>
            <td class=xl87></td>
            <td class=xl87></td>
            <td class=xl87></td>
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>BAN BELAKANG</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->ban_blk == "Baik")
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left: none'>STIR / KEMUDI</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->stir_kemudi2 == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->stir_kemudi2 == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>DRUM (RODA EMPAT)</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->drum == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td class=xl94></td>
            <td class=xl95>10</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>STROBE</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->strobe == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TUAS GIGI TRANSMISI</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tuas_gigi_trans == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tuas_gigi_trans == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td class=xl94></td>
            <td class=xl95>12</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TUAS MAJU / MUNDUR</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tuas_maju_mdr == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tuas_maju_mdr == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tuas_maju_mdr == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>HANDLE CONTROL</td>
                        <!-- Pemisah Kolom untuk Baik -->
