            ...
            <div class="container mx-auto p-0">
                <form action="{{ route('cert.store') }}" method="POST">
                    ...
                    <div class="grid gap-4 sm:gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input type="text" name="agenda" id="agenda"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Praktik Kerja Lapangan" required />
                            </div>
                        </div>

                        {{-- <div>
                            <label for="agenda" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Jenis Sertifikat
                            </label>
                            <div class="relative flex items-center">
                        ...
                        <div>
                            <label for="site_mgr" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Site Manager
                                </label>
                            <div class="relative flex items-center">
                                <input type="text" name="site_mgr" id="site_mgr"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Site Manager" required />
                            </div>
                        </div>
