...
@section('content')
    ...
    <section class="min-h-screen bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16 !pt-28">
            <img class="azvan h-auto max-w-full rounded-lg" src="{{ asset('storage/images/DT.svg') }}" alt="Azvan IT">
            ...
            <div class="container mx-auto p-0">
                ...
                <form action="{{ route('form-dumptruck') }}" method="POST" id="myForm">
                    @csrf
                ...
                <div id="chatBubble"
                    ...
                    <a href="{{ url('./hasil-dumptruck') }}" id="chatButton" class="chat-bubble-btn">
                        <!-- Chat Bubble Icon -->
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        chatButton.addEventListener('click', function() {
                            window.location.href = './hasil-dumptruck'; // Navigate to the URL
                        });
                    });
                </script>
                            ...
                            .then(data => {
                                Swal.fire({
                                    ...
                                    if (result.dismiss === Swal.DismissReason.cancel) {
                                        ...
                                        window.location.href = './hasil-dumptruck';
                                    } else {
