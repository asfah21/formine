...
<script>
    function saveAsPDF() {
        ...
        var opt = {
            ...
            filename:     'Form-P2H-Bulldozer-GSI.pdf', // Nama file PDF yang akan disimpan
...
@endphp
            ...
            height:11.1pt;border-left:none'>BULLDOZER</td>
            ...
            <td colspan=8 rowspan="4" class=xl184>  <!-- tempat tanda tangan user -->
                <img id="res-img" src="{{ asset('storage/images/ttd_bd/' . $Dtl->bd_id . '.png') }}" alt="No data" style="width: 43%; height: 90%; margin: 7% 0% 0% 0%;"></td>
            <td class=xl87></td>
            <td class=xl87></td>
            <td class=xl87></td>
            <td class=xl87></td>
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KAP & TRUNION PUSH ARM</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->kap_trunion == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kap_trunion == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->kap_trunion == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>FINAL DRIVE</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->final_drive == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->final_drive == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SEGMENT SPROCKET</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->segmen_sprocket == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->segmen_sprocket == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->segmen_sprocket == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>3</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>LEVEL OLI PIVOTSHAFT</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->level_oli_pivot == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->level_oli_pivot == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->level_oli_pivot == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left: none'>LEVEL OLI HIDROLIK</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->level_oli_hidro2 == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->level_oli_hidro2 == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TUAS KONTROL</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tuas_control == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tuas_control == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>RIPPER</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->ripper == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td class=xl94></td>
            <td class=xl95>8</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TROTTLE (GAS TANGAN)</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->trottle == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->trottle == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->trottle == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>BATTERY</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->bettery == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->bettery == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>9</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>PEDAL DECELATOR</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->pedal_dece == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->pedal_dece == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->pedal_dece == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>PIVOT SHAFT</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->pivot_shaft == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->pivot_shaft == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->pivot_shaft == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>10</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KEMUDI (STEERING CLUTCH)</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->kemudi == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TUAS TRANSMISI</td>
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tuas_trans == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tuas_trans == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SILINDER TILT BLADE</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->silinder_tilt == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->silinder_tilt == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->silinder_tilt == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>SILINDER LIFT BLADE</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->silinder_lift == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->silinder_lift == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->silinder_lift == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>13</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>TUAS REM</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->tuas_rem == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->tuas_rem == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->tuas_rem == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KABIN LUAR</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->kabin_luar == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
                            <td class=xl96 ></td>
                        @endif
                        ...
                        <!-- Pemisah Kolom untuk Rusak -->
                        @if ($Dtl->kabin_luar == "Rusak")
                            <td style="font-weight:normal;text-align:center"class=xl97 >&#10006;</td>
                        @elseif ($Dtl->kabin_luar == "Tidak Ada")
                            <td style="font-weight:normal;text-align:center"class=xl97 >-</td>
                        @else
                            <td class=xl97 ></td>
                        @endif
            <td class=xl94></td>
            <td class=xl95>16</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>LMAPU MUKA BELAKANG</td>
                        <!-- Pemisah Kolom untuk Baik -->
            ...
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>KIPAS KACA</td>
                        <!-- Pemisah Kolom untuk Baik -->
            ...
            <td class=xl94></td>
            <td class=xl95>20</td>
            <td colspan=10 class=xl155 style='border-right:.5pt solid black;border-left:none'>RADIO</td>
                        <!-- Pemisah Kolom untuk Baik -->
                        @if ($Dtl->radio == "Baik")
                            <td style="font-weight:normal;text-align:center"class=xl96 >&#10004;</td>
                        @else
